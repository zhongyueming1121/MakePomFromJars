 ...
 * @author ymz
 */
public class MakePomFromJarsNotProperties {
    /**
     * 需生成pom文件的 lib路径
     */
    private static final String libPath = "W:/CODE/passport/lib";
    /**
     * 输出文件
     */
    private static final String outFilePath = "W:/CODE/passport/output.txt";
